...
PILLARS = [
    # Verbatim from the the AI platform Customer Deck — these are the
    ...
    # guide where the same four show up as the "Why AI" sections.
    {
...
AUDIENCES = [
    # The Brand and Audience insights Team's 11 canonical <vendor> personas,
    # transcribed from "Writing for <vendor> Notes". Goal / Content Needs /
