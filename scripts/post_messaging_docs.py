"""POST hand-extracted Red Hat AI product messaging docs to Scout.
...
DOCS: list[dict[str, Any]] = [
    {
        "title": "Red Hat AI (umbrella)",
        "source_type": "structured",
        "elevator_pitch": (
            "Red Hat AI accelerates the development and deployment of "
        ...
        "key_themes": [
            "Efficient inferencing (vLLM, llm-d, LLM compressor, Granite)",
            "Connecting models to data (InstructLab, RAG, RAFT, synthetic data)",
            "Agentic AI innovation (Llama Stack API, MCP, AI hub, gen AI studio)",
            "Hybrid cloud AI at scale (MLOps, GenAIOps, MaaS, air-gapped)",
        ...
        "talking_points": [
            ...
            "Granite model family: smaller, Apache-2.0-licensed, fully indemnified by Red Hat",
            "Pre-optimized model repository on the Red Hat AI Hugging Face page",
            "InstructLab + RAFT pattern for cost-effective domain alignment",
        ...
        "differentiators": [
            ...
            "Apache-2.0 Granite models with IP indemnification",
            "Open-source-first stack with enterprise support contract",
        ],
        "competitive_position": (
            "Red Hat AI counter-positions against hyperscaler AI services by "
            ...
            "model collections under a single Red Hat contract."
        ),
        "is_active": True,
    },
    {
        ...
        "source_type": "structured",
        "elevator_pitch": (
            "Red Hat AI Enterprise is an integrated AI platform for deploying "
        ...
        "differentiators": [
            ...
            "Tested, supported AI stack with Red Hat enterprise commitments",
        ...
        "competitive_position": (
            "Red Hat AI Enterprise differentiates by unifying model and "
            ...
            "lives — on-premise, edge, or public cloud — with Red Hat support "
    ...
    },
    {
        ...
        "source_type": "structured",
        "elevator_pitch": (
            "Red Hat Enterprise Linux AI (RHEL AI) is a foundation model "
            "platform for running large language models in individual server "
            "environments. The solution includes the Red Hat AI Inference "
        ...
        "key_themes": [
            "Open-source Granite family LLMs",
        ...
        "talking_points": [
            "Empower innovation with enterprise-grade open-source Granite models, fully indemnified",
            "Red Hat AI Inference Server boosts efficiency by optimizing GPU usage with vLLM",
        ...
        "differentiators": [
            ...
            "Granite models packaged + supported by Red Hat with IP indemnification",
            "vLLM-based inference avoids per-accelerator runtime fragmentation",
            "24×7 enterprise support + extended model lifecycle",
        ],
        "competitive_position": (
            "RHEL AI counter-positions against proprietary cloud-only LLM "
            "stacks by packaging Granite + vLLM as a bootable appliance you "
    ...
    },
    {
        ...
        "source_type": "structured",
        "elevator_pitch": (
            "Red Hat OpenShift AI is an AI platform for building, training, "
            "deploying, and governing predictive and generative AI models at "
            "scale across hybrid cloud environments. Building on Red Hat "
        ...
        "talking_points": [
            ...
            "JupyterLab + RAG + InstructLab training for model alignment",
        ...
        "competitive_position": (
            "OpenShift AI competes with hyperscaler AI platforms by giving "
    ...
    },
    {
        ...
        "source_type": "structured",
        "elevator_pitch": (
            "Red Hat AI Inference Server provides consistent, fast, and "
        ...
        "talking_points": [
            ...
            "Optimized model repository on the Red Hat AI Hugging Face page (2-4x efficiency)",
            "Certified for all Red Hat products: OpenShift AI, RHEL AI, OpenShift, RHEL",
            "Third-party platform support: non-Red Hat Linux + Kubernetes covered",
        ...
        "differentiators": [
            ...
            "Available across the Red Hat portfolio + third-party platforms",
        ...
        "competitive_position": (
            ...
            "adds Red Hat support, IP indemnification, and validated, "
