...
DAAM team. Unknown codes default to "different continent" so unmapped
...
COUNTRY_TO_CONTINENT: Final[dict[str, str]] = {
    ...
    # ---- Europe ----
    "GB": "EU", "IE": "EU", "FR": "EU", "DE": "EU", "ES": "EU", "PT": "EU",
    "IT": "EU", "NL": "EU", "BE": "EU", "CH": "EU", "AT": "EU", "DK": "EU",
    "SE": "EU", "NO": "EU", "FI": "EU", "PL": "EU", "CZ": "EU", "RO": "EU",
    "GR": "EU", "TR": "EU", "EE": "EU", "LT": "EU", "LV": "EU", "HU": "EU",
    "BG": "EU", "HR": "EU", "SI": "EU", "SK": "EU", "IS": "EU", "UA": "EU",
    "RU": "EU",  # treated as EU for conference-circuit purposes
    # ---- Asia ----
    "JP": "AS", "KR": "AS", "CN": "AS", "TW": "AS", "HK": "AS", "SG": "AS",
    "IN": "AS", "ID": "AS", "MY": "AS", "TH": "AS", "VN": "AS", "PH": "AS",
    "AE": "AS", "SA": "AS", "IL": "AS", "PK": "AS", "BD": "AS",
    # ---- Oceania ----
    "AU": "OC", "NZ": "OC",
    # ---- Africa ----
