...
Same client talks to MaaS for both. Switch providers by changing 3 env vars
...
Every call:
  ...
  4. Calls MaaS via the openai SDK (or returns a dry-run fake).
...
class LLMClient:
    ...
    def __init__(self, settings: Settings | None = None) -> None:
        ...
        self._openai = AsyncOpenAI(
            ...
            # Default timeout. Long enough for slow MaaS responses; short
    ...
    async def _call_chat(self, model: str, req: ChatRequest) -> Any:
        """Make the actual MaaS call with retries."""
        retry = get_retry()
